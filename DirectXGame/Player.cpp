...
#pragma region プレイヤーと梯子の当たり判定
void Player::CheckLadderCollision(CollisionMapInfo& info) {

	CheckLadderCollisionUp(info);
	CheckLadderCollisionDown(info);
	CheckLadderCollisionRight(info);
	CheckLadderCollisionLeft(info);
}

#pragma region 上
// 02_07 スライド14枚目(上下左右全て)
void Player::CheckLadderCollisionUp(CollisionMapInfo& info) {
...
#pragma region 下
void Player::CheckLadderCollisionDown(CollisionMapInfo& info) {
...
// 02_08スライド14枚目 設置状態の切り替え処理
void Player::UpdateOnLadder(const CollisionMapInfo& info) {
...
#pragma region 右
// 中身入れるのは02_08スライド25枚目
void Player::CheckLadderCollisionRight(CollisionMapInfo& info) {
...
#pragma region 左
// 中身入れるのは02_08スライド25枚目
void Player::CheckLadderCollisionLeft(CollisionMapInfo& info) {
